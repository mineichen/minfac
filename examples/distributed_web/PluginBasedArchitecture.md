...
If you just want to separate your code into multiple projects, you can simply link your plugins statically to avoid ABI stability, as we did with the raf-* projects.
